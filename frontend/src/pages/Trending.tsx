...
const Trending = () => {
  ...
  return (
    <>
      ...
      <div className="mt-3">
        <div className="cursor-pointer relative w-60 h-60 bg-gray-200/0 overflow-hidden justify-center flex rounded-md">
          <div className="z-0 absolute w-50 h-40 bg-gray-200/20 rounded-xl top-0"></div>
          <div className="z-10 absolute w-55 h-50 bg-gray-400/80 rounded-xl top-3"></div>
          <div className="z-100 absolute w-60 h-60 rounded-xl top-6 overflow-hidden border-2 border-gray-100/40">
            <img 
                src="./playlist/Africa_playlist.png"
                alt="" 
                className=""
            />
          </div>
